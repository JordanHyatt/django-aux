...
from django_aux.columns import CollapseColumn, RoundNumberColumn, BarChartColumn, NoSBCollapseColumn
...
class PersonTable(tables.Table):
    ...
    longtxt = NoSBCollapseColumn(accessor='long_text', style='background-color: blue; color: yellow')
