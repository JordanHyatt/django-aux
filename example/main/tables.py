...
class PersonTable(tables.Table):
    ...
    adjectives = CollapseIterableColumn(accessor='adjectives.all', verbose_name='Adjectives', order_items_by=['word']) # regular iterable
    ...
    longtxt = CollapseNoniterableColumn(accessor='long_text', style='background-color: blue; color: yellow; min-width:50vw') # non-iterable using style
    org = CollapseNoniterableColumn(accessor='org', orderable=True, label_accessor='org__name') # non-iterable with dynamic label
